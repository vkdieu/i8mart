            ...
            <div class="card-body">
                <form action="{{ route('Page.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content" cols="30" rows="5" name="content">{{ old('content', $page->content) }}</textarea>
                    </div>
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="file" name="file" id="file" data-uri=""><br /><br />
                        <input id="thumbnail_url" type="hidden" name="thumbnail_url" value="" />
                        <div id="show_list_file"><img style="height: 80px; width: 80px;" src="{{ asset($page->thumbnail) }}"
                                alt="">
                        </div>
                    </div> --}}
