            ...
            <div class="card-body">
                <div class="analytic">
                    ...
                    <a href="{{ request()->fullurlWithQuery(['status' => 'stocking']) }} " class="text-primary">Còn
                        hàng<span class="text-muted">({{ $stocking_count }})</span></a>
                    <a href="{{ request()->fullurlWithQuery(['status' => 'out_of_stock']) }} " class="text-primary">Hết
                        hàng<span class="text-muted">{{ $out_of_stock_count }}</span></a>
